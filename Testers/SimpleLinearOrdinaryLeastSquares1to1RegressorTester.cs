...
namespace Regressors.Testers
{
    public class SimpleLinearOrdinaryLeastSquares1to1RegressorTester
    {
        ...
        public SimpleLinearOrdinaryLeastSquares1to1RegressorTester(List<USModel> mylist)
        {
            this.mylist = mylist;
        }
        public void RunTest()
        {
            Run(OneVarRealFuncSynthDataSetGenerator.GenerateArcTanDS, 1, mylist.Count, 1, 0.045, "LOLSR_05_");
        }
...
";
        ...
        )
        {
            ...
            LinearOrdinaryLeastSquares1to1Regressor r = new LinearOrdinaryLeastSquares1to1Regressor(mylist);
